...
**Last updated:** 2026-08-19 18:49 UTC · **Rules:** v1.1 (2026-08-18) · **Data:** NQ202609: 3499 bars, 2026-07-29 → 2026-08-16; NQF-continuous: 14059 bars, 2026-06-08 → 2026-08-19; CL: 13827 bars, 2026-06-09 → 2026-08-19; ES: 13784 bars, 2026-06-09 → 2026-08-19
...
|---|---|---|---|---|---|
| **−$3,895** | 21 (3T/15S/3X) | 28.6% | 0.56 | $6,755 | −$185 |
...
|---|---|---|---|---|---|---|
| NQ | 21 | 28.6% | -0.35 | -7.45 | 0.5 | −$3,895 |
...
|---|---|---|---|---|---|---|
| OLD — base spec · all markets · all windows | 54 | 33.3% | -0.182 | -9.81 | 0.74 | -0.196 → -0.151 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | 2R · breakeven stop after +1R | 54 | 31.5% | -0.067 | -3.63 | 0.88 | -0.333 (21) | 0.193 (28) | -0.409 (5) | -0.017 → -0.168 | — |
| 2 | 1R target · stop@sweep | 54 | 48.1% | -0.136 | -7.33 | 0.75 | -0.333 (21) | 0.061 (28) | -0.409 (5) | -0.036 → -0.335 | — |
| 3 | 2R target · stop@sweep (base) | 54 | 33.3% | -0.182 | -9.81 | 0.74 | -0.389 (21) | 0.05 (28) | -0.609 (5) | -0.161 → -0.224 | — |
| 4 | 2R · no time exit (hold 6.5h) | 54 | 29.6% | -0.205 | -11.05 | 0.73 | -0.407 (21) | 0.019 (28) | -0.609 (5) | -0.119 → -0.375 | — |
| 5 | 3R target · stop@sweep | 54 | 27.8% | -0.214 | -11.53 | 0.72 | -0.5 (21) | 0.179 (28) | -1.209 (5) | -0.059 → -0.523 | — |
| 6 | 1.5R target · stop@sweep | 54 | 35.2% | -0.274 | -14.81 | 0.6 | -0.461 (21) | -0.057 (28) | -0.709 (5) | -0.244 → -0.335 | — |
| 7 | 3R target · stop@gap edge | 112 | 24.1% | -0.194 | -21.76 | 0.77 | -0.371 (40) | -0.102 (38) | -0.089 (34) | -0.158 → -0.275 | — |
| 8 | 1.5R target · stop@gap edge | 112 | 36.6% | -0.211 | -23.65 | 0.71 | -0.235 (40) | -0.268 (38) | -0.119 (34) | -0.253 → -0.12 | — |
| 9 | FADE the setup (take opposite side) | 54 | 24.1% | -0.447 | -24.15 | 0.42 | -0.417 (21) | -0.441 (28) | -0.609 (5) | -0.539 → -0.264 | — |
| 10 | 2R target · stop@gap edge | 112 | 27.7% | -0.296 | -33.15 | 0.64 | -0.435 (40) | -0.176 (38) | -0.266 (34) | -0.272 → -0.348 | — |
| 11 | 1R target · stop@gap edge | 112 | 38.4% | -0.358 | -40.15 | 0.49 | -0.41 (40) | -0.387 (38) | -0.266 (34) | -0.376 → -0.32 | — |
...
|---|---|---|---|---|---|---|
| 2026-08-19 | PM 2-3pm | bull | 29537.75 | 46.0 | time | +$150 |
